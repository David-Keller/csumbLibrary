...
public class CancleHold extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if(error == 0){
                    Toast.makeText(CancleHold.this,"Incorrect Username or password", Toast.LENGTH_LONG).show();
                }
                else{
                    Intent i = new Intent(CancleHold.this, CancleHoldList.class);
